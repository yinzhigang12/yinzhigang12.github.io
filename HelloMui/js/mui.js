...
(function ($) {
    ...
    //TODO 鑷姩璋冪敤init?鍥犱负鐢ㄦ埛鑷繁璋冪敤init鐨勬椂鏈哄彲鑳戒笉纭畾锛屽鏋滄櫄浜庤嚜鍔╥nit锛屽垯浼氭湁娼滃湪闂
    //	$.ready(function() {
    //		setTimeout(function() {
    //			if (!isInitialized) {
    //				$.init();
        ...
        if (webviewCache && webview) { //宸茬紦瀛�
            ...
            if (nShow.autoShow) {
                var showWebview = function () {
                    ...
                    //鏄剧ず椤甸潰
                    webview.show(nShow.aniShow, nShow.duration, function () {
                        //titleUpdate浜嬩欢鍙戠敓杈冩棭锛屽緢澶氱幆澧冨皻涓嶅叿澶�
                        // triggerPreload(webview);
                        // trigger(webview, 'pagebeforeshow', false);
                    });
                    webview.showed = true;
                ...
                //TODO 鑳借蛋鍒拌繖涓€姝ワ紝搴旇涓嶇敤鍒ゆ柇url浜嗗惂锛�
                if (!url) {
                    showWebview();
                } else {
 ...
 */
(function ($, document) {
    if (!($.os.plus && $.os.android)) { //浠呭湪5+android鏀寔澶歸ebview鐨勪娇鐢�
        return;
    }
    $.plusReady(function () {
        ...
        var PlusPullRefresh = $.Class.extend({
            ...
            handleEvent: function (e) {
                ...
                //5+鐨刾lusscrollbottom褰撻〉闈㈠唴瀹硅緝灏戞椂锛屼笉瑙﹀彂
            ...
            pulldownLoading: function () { //璇ユ柟娉曟槸瀛愰〉闈㈣皟鐢ㄧ殑
                $.plusReady(function () {
            ...
            endPulldownToRefresh: function () { //璇ユ柟娉曟槸瀛愰〉闈㈣皟鐢ㄧ殑
                var webview = plus.webview.currentWebview();
    ...
    var backdrop = (function () {
        ...
        element.addEventListener('tap', function (e) {
            ...
            if (popover) {
                ...
                document.body.setAttribute('style', ''); //webkitTransitionEnd鏈夋椂鍊欎笉瑙﹀彂锛�
            }
        });
